...
foreach ($query as $data) {
    $row = array($data["num"], $data["firstName"], $data["lastName"], $data["state"]);
...
<div class="container container--narrow page-section">
  <div class="page-links">
        <h5 class="page-links__title active">Account Management <a href="javascript:void(0);" class="icon" onclick="myFunction()">
...
<?php
    if ($_SESSION['loggedin'] == 1 && $_SESSION['userLevel'] == 3) { ?>
                    <a class="nav-link" aria-current="page" href="#"> Registered Site User Reports </a>
                    <a class="nav-link" href="/reports/index.php?action=reports"> Admin Page </a>
                <?php } ?>
                <?php
                ...
                <?php } else { ?>
                    <a class="nav-link" <?php echo $url2 ?>> Knox Registration</a>
                <?php }  ?>
         ...
         <h5 class="heading1"> Account Details </h5>
       
        <div class="one-half">
            <div> <button id="list" class="btnDisplay">Registered Site Users</button>
            </div>
        ...
        <div class="one-half">
            <div> <button id="age" class="btnDisplay" onclick="age();" style="width: 100%; ">
                    Participants By Age
            </div> </button>
        ...
        <div class="one-half">
            <div>
                <button id="state" onclick="state();" class="btnDisplay ">Participants By State </button>
            </div>
        ...
        <div class="one-half">
            <div>
                <button id="widowed" onclick="widowed();" class="btnDisplay ">Participants By Time Widowed</button>
            </div>
            <div id="Kdata5" class="column" style="display:none;">
                <canvas id="myChart4"></canvas>
                <?php
                $newArray5 = json_decode(json_encode($newData5));
                //var_dump($data); 
                ?>
                ...
                <table id="data">
                    ...
                    <tr>
                        <th> Total </th>
                        <td><?php echo $widPerc1 ?></td>
                        <td><?php echo $widTotal ?></td>
                    </tr>
                </table>
