...
?>
    ...
    <div class="container container--narrow page-section">
        ...
        <h5 class="heading1"> Confirm Account </h5>
        ...
        <form action="/accounts1/index.php" method="post">
            ...
            <select name="conf" id="conf" class="input" required>
            ...
            <p class="display" style="color: red; margin-left: 5px;"> The password needs to be 8 characters long, contain at least 1 uppercase character, <br> 1 number and 1 special character</p>
