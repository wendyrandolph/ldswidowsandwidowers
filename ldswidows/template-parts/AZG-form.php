...
$_SESSION['getRegData'];
//var_dump($_SESSION['getRegData']); 
//exit; 
$act_1 = $_SESSION['getRegData'][0]['act_1'];
$act_2 = $_SESSION['getRegData'][0]['act_2'];
//$act_3 = $_SESSION['getRegData'][0]['act_3'];
//$act_4 = $_SESSION['getRegData'][0]['act_4'];
$act_5 = $_SESSION['getRegData'][0]['act_5'];
$keynote_1 = $_SESSION['getRegData'][0]['keynote_1'];
$meal_1 = $_SESSION['getRegData'][0]['meal_1'];
$confId = $_SESSION['getRegData'][0]['conf_id'];
$userId = $_SESSION['getRegData'][0]['userId'];
$emergencyName = $_SESSION['getRegData'][0]['emergencyName'];
$emergencyPhone = $_SESSION['getRegData'][0]['emergencyPhone'];
?>
<br> 
