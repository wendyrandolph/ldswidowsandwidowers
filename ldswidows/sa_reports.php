...
require_once($_SERVER['DOCUMENT_ROOT'] . '/model/reports-model.php');
    ...
    foreach ($query3 as $data3) {
        ...
        $row3 = array($data3["gender"],  $percent, $data3["Count(sanAnt_id)"]);
...
<div class="container container--narrow page-section">
 ...
 <div class="row_3">
   ...
   ?>   <div class="container container--narrow page-section">
   <h5 class="heading1">San Antonio Reports - 2023 </h5>
                    ...
                    <tbody style="width:100%;">
                        <tr style="width: 100%;">
                            <th style="width: 30%;">Date</th>
                             <th style="width: 30%;">Total Registered By Date </th>
        ...
        <br> <hr style="width: 50%; float:left; border: 1px solid black;">
            ...
            <div id="data" class="table-responsive column" style="display:none;"><br><br>
                <table id="data" class="table table-bordered">
                    <form method="post" action="/library/exportSA.php" align="center">
                    ...
                    <?php foreach ($newArray as $row) {  ?>
                        <tr>
                           ...
                           <!--<td><button class='btn btn--dark-orange btn--dark-orange:hover' style='width: 50%;'><a href='/users/index.php/?action=iDelete&userId="<?php echo $row[4]; ?>"?&confId3=<?php echo $confId3 ?>"'>Delete</a></button></td>
                       --> <?php } ?>
                        </tr>
                </table>
            </div>
...
<br>
            <div id="Kdata5" class="column" style="display:none;">
             ...
             <hr style="width: 100%; float:left; border: 5px solid black;">

       
            <h5 class="heading1" style="width: 100%""> User Account</h5>
 <p class="t-left"> <strong>Need to check if someone has created an account?</strong>
       <form id="checkAccount" class="step3" action="/users/index.php" method="post">
         ...
         <input class="btn btn--blue float-left push-right" type="submit" id="Submit" name="submit" value="Check for Account"> <br> <br>
