...
?>
    ...
    <div class="page-banner">
        <?php pageBanner(array(
            'title' => "Salt Lake Conference Reports"
        )); ?>
    </div>
    ...
    <div class="container container--narrow page-section">
        <div class="metabox metabox--position-up metabox--with-home-link">
            <p>
                ...
                <a class="metabox__blog-home-link" href="<?php echo get_the_permalink(); ?>"><i class="fa fa-home" aria-hidden="true"></i>All Conferences</a> <span class="metabox__main"><?php the_title(); ?> </span>
    ...
    <h5 class="heading1">2023 - <?php echo the_title(); ?> </h5>


    <div> <button id="list" class="btnDisplay">Registered Attendees</button>
    </div>
            ...
            <tbody style="width:100%;">
                ...
                foreach ($newArray2 as $row2) { ?>
                    <tr style="width: 100%;">
                        ...
                        <td style="width: 15%;"> <?php echo $row2[3] ?></td>
                    </tr>
                <?php  } ?>
            </tbody>
        </table>
