...
<div class="page-links">
            ...
            <?php
            if (($post->ID == '2738') and $_SESSION['idaho'] == 'True') { ?>
                <h5 class="page-links__title"> Manage Registration </h5>
              <li> <a  name='update' href=' /users/index.php?action=iUpdate&confId3=<?php echo $confId3 ?>'> Update My Registration </a></li>
             <li> <a name="cancel" href=" /users/index.php?action=iDelete&confId3=<?php echo $confId3 ?>"> Cancel My Registration </a></li>
           <?php } ?>
...
<div class="container container--narrow page-section">
  ...
  <?php  }
    ...
    if (($post->ID = 2738) and $_SESSION['idaho'] == 'False') { ?>
       
       <!-- <h5 class="heading1">Conference Registration - Step 1</h5>
    <?php  }elseif (($post->ID = 2738) and $_SESSION['manual'] == 'True') { ?>
        <h5 class="heading1">Manual Registration - Step 1</h5>
   --> <?php  } 
        ...
        /*   if (!$_SESSION['loggedin']) { ?>
                <form action="/accounts1/index.php" method="post">
                    ** If you have not created an account, please do so first.
                    ...
                    <input class="btn btn--small btn--blue float-left push-right" type="submit" name="submit" value="Sign In" id="submit"> <br> <br>
                    <input type="hidden" name="action" value="Conf_Login_Id">
        ...
        <?php   }  */
          ...
          <div class="full-width-split">
                <div class="full-width-split__one">
                    ...
                    <?php  } elseif ($_SESSION['idaho'] == 'True') { ?>
                       
                        <ul>

                            <?php echo $_SESSION['buildId'];  ?>
                        </ul>
              <?php  } 
              } ?>
