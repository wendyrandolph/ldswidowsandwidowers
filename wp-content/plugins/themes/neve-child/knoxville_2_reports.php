...
--> <?php
    if ($_SESSION['loggedin'] == 1 && $_SESSION['userLevel'] == 3) { ?>
        ...
        <div class="row_1">
            <div> <button id="list" class="btnDisplay"><span>List of Participants</span> </button>
            </div>
    ...
    <script>
        ...
        $("#list").on("click", function() {
            if ($("#data").is(":hidden")) {
                ...
                $("#data").slideUp("slow");
                $('#list').text('List of Participants.');
            }
        });
        ...
        $("#activity").on("click", function() {
            if ($("#report1").is(":hidden")) {
                ...
                $('#activity').text('Participants By Activity');
            }
        });
...
$("#age").on("click", function() {
   if ($("#Kdata2").is(":hidden")) {
          $("#Kdata2").slideDown("slow")
                $('#age').text('X');
            } else {
                $("#Kdata2").slideUp("slow");
                $('#age').text('Participants By Age');
            }
        });  
...
$("#gender").on("click", function() {
   if ($("#Kdata3").is(":hidden")) {
          $("#Kdata3").slideDown("slow")
                $('#gender').text('X');
            } else {
                $("#Kdata3").slideUp("slow");
                $('#gender').text('Participants By Age');
            }
        });  

        $("#state").on("click", function() {
   if ($("#Kdata4").is(":hidden")) {
          $("#Kdata4").slideDown("slow")
                $('#state').text('X');
            } else {
                $("#Kdata4").slideUp("slow");
                $('#state').text('Participants By Age');
            }
        });  
