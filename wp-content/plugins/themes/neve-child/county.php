...
foreach ($query as $data) {
    ...
    $number[] = $data['Count(email)'];
           ...
           $row = array($data["county"],  $percent, $data['Count(email)']); 
...
<?php
        ...
        <div class="trial">
            <div class="row_1">
                ...
                <div id="column" style="width: 100%; ">
                    ...
                    echo '<tr>';
                    echo '<th> County </th> <th>Percentage </th> <th> # of Particpants </th>';
                    echo '</tr>';
    ...
    <script>
const data = {
            labels: <?php echo json_encode($county) ?>,
            datasets: [{
                label: 'Participants By Utah County',
