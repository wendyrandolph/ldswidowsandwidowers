...
--> <?php
    if ($_SESSION['loggedin'] == 1 && $_SESSION['userLevel'] == 3) { ?>
                    <a class="adminBtn active" aria-current="page" href="#"> Registered Site User Reports </a>
        ...
        <div class="row_1">
            ...
            <div id="data" class="table-responsive column" style="display:none;">
                <header class="btnDisplay btnDisplay1">Registered Site Users</header>
        ...
        <div class="row_1">
            ...
            <div id="Kdata5" class="column" style="display:none;">
                <header class="btnDisplay btnDisplay1"> Participants By Time Widowed </header>
